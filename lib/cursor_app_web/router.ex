defmodule CursorAppWeb.Router do
  ...
  import CursorAppWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {CursorAppWeb.Layouts, :root}
  ...
  # scope "/api", CursorAppWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:cursor_app, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: CursorAppWeb.Telemetry
  ...
  scope "/", CursorAppWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{CursorAppWeb.UserAuth, :redirect_if_user_is_authenticated}] do
